...
export class M4 {
    ...
    * multiplying the matrices together.  For given a and b, this  returns
    ...
    * transforming that surface by the matrix. The effect of this  is the
    * same as transforming v (as a direction) by the inverse-transpose of m.  This
    *  assumes the transformation of 3-dimensional space represented by the
